...
//     : { fullName: "User", email: "user@email.com" };
...
//             } text-xl text-gray-300 hover:text-white hover:bg-cyan-400 p-1 rounded-lg transition`}
//           >
...
//         {!collapsed && (
//           <button className="flex items-center gap-2 text-lg w-full hover:bg-gray-700 p-2 rounded-lg transition">
//             <Moon /> Dark mode
//           </button>
//         )}
...
//             navigate("/login");
//           }}
//           className={`flex items-center gap-2 text-lg cursor-pointer hover:bg-red-600 rounded-2xl h-10 transition w-full justify-center ${
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth < 768) {
        ...
        setCollapsed(false); // desktop = full
      }
    };
